...
@customElement('bkb-laliga-table-list-item')
export class LaLigaTableListItemComponent extends LitElement {
  ...
  public data: LaLigaTableEntry;

  protected render(): TemplateResult {
    const teamHref = `${BASE_PATH_WITHOUT_DOMAIN}/${COMPETITION_CONFIG.competitionRoute}/team/${this.data.teamName}`;
    ...
    return html`
      <a class="root" href=${teamHref}>
        ...
        <div class="team-logo">
          <img src="${logoSrc}" alt="Logo von ${this.data.teamName}" />
        </div>
